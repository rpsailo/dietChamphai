...
@section('content_header')
    <h1>Edit Faculty Subject Mapping</h1>
@stop

@section('content')
    <p>Faculty Subject Mapping</p>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="faculty" id="" class="form-control" required>
                                    <option value="{{ $facultySubject->facultyId }}" selected>{{ $facultySubject->facultyName }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="subject" id="" class="form-control" required>
                                    <option value="{{ $facultySubject->semesterId }}" selected>{{ $facultySubject->subjectName }}</option>
